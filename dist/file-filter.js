...
class FileFilter {
     ...
     */
    static shouldExclude(file) {
        const path = file.path;
        return (this.isLockfile(path) ||
     ...
     */
    static prioritizeFiles(files, maxFiles) {
